document.addEventListener('DOMContentLoaded', () => {
    ...
    const grains = [
        {
            "17c": {
                title: "Дурень шукає собі місце, а розумного і вкутку видно",
                description: "Байка розповідає про те як Сапфір пише своєму другу діамантію, і розповідає про те що він при дворі і весь такий сяючий а діамант не оброблений у вулканічному попелі і не сяє",
            ...
            "21c": {
                ...
                description: "Історія може бути адаптована до сучасного контексту, де сапфір та діамант представляють двох колег у корпоративному середовищі. ",
