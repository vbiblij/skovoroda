document.addEventListener('DOMContentLoaded', () => {
  ...
  { pairLabel: 'Два коштовні камені 1769', cards: [{ name: 'Діамант', icon: '💎' }, { name: 'Смарагд', icon: '💚' }] }
    ...
    updateStats();
    showModal('Правила: Кожна пара карток належить одній байці. Виберіть одну картку, потім другу. Якщо пара правильна — обидві картки зникнуть. Якщо ні — з рахунку відніметься 1 бал.');
});